        ...
        if opcion == 1:
            ...
            try:
                ...
                if not isinstance(marca, int):
                    ...
                    for i in range(cantidad_modelo):
                        ...
                        if precio < rango_dinero[0] or precio > rango_dinero[1]:
                            os.system("cls")
            ...
            try:
                ...
                if opcion == 1:
                    ...
                    if index_marcas > len(marcas) or cantidad_modelo > len(vehiculos[(marcas[index_marcas-1])]):
                        os.system("cls")
                        print("Erorr, intentalo de nuevo"); print("")
                        input("Pulsa enter para continuar ")
                        os.system("cls")
